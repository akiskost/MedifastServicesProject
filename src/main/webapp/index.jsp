        ...
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-md-6 col-lg-5 text-center">
                <div class="about_us_text ">
                    <h2>Welcome to Medifast</h2>
                    <p></p>
                    <a class="btn_2" href="${pageContext.request.contextPath}/jsps/login.jsp">Login</a>

                    <div class="banner_item">

                        <div class="single_item">
                            <img src="${pageContext.request.contextPath}/static/img/icon/banner_2.svg" alt="">
