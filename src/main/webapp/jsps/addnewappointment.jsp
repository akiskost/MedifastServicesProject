                ...
                <div class="depertment_content">
                    ...
                    <div class="row justify-content-center text-left">
                        <div class="col-xl-4">
                            ...
                            <br>
                            <form method="POST" action="${pageContext.request.contextPath}/addappointment">
                                <div class="form-group">
                                    <input name="pid" type="text" class="form-control" id="app1" value="${param.pid}" readonly>
                                </div>
                                <div class="form-group">
                                    <input name="firstname" type="text" class="form-control" id="app2" value="${param.firstname}"readonly>
                                </div>
                                <div class="form-group">
                                    <input name="lastname" type="text" class="form-control" id="app3" value="${param.lastname}" readonly>
                                </div>
                                <div class="form-group ">
                                    <select name="exam" class="form-control form-select" id="app4" required>
                                        <option> Choose Exam </option>
                                        <option value="101">General Check up</option>
                                        <option value="102">Blood testing</option>
                                        <option value="103">Eye exam</option>
                                        <option value="104">Xray</option>
