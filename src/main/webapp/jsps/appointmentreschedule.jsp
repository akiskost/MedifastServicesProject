...
<head>
    ...
    <title>Medifast - Reschedule Appointment</title>
                ...
                <div class="depertment_content">
                    <div class="row justify-content-center text-left">
                        <div class="col-xl-4">
                            ...
                            <br>
                            <form method="POST" action="${pageContext.request.contextPath}/reschedule">
                                <div class="form-group">
                                    <label for="res1">Appointment ID</label>
                                    <input name="apid" type="text" class="form-control" id="res1" value="${param.apid}" readonly >
                                </div>
                                <div class="form-group">
                                    <label for="res2">First Name</label>
                                    <input name="firstname" type="text" class="form-control" id="res2" value="${param.firstname}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="res3">Last Name</label>
                                    <input name="lastname" type="text" class="form-control" id="res3" value="${param.lastname}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="res4">New Date </label>
                                    <input name="date" type="date" class="form-control" id="res4" value="${param.date}">
                                </div>
                                <div class="form-group">
                                    <label for="res5">Exam</label>
                                    <input name="exam" type="text" class="form-control" id="res5" value="${param.exam}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="res6">Result</label>
                                    <input name="result" type="text" class="form-control" id="res6" value="${param.result}" readonly>
                                </div>
